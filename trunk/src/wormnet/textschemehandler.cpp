...
textschemehandler::textschemehandler(QWidget *parent) :
    ...
    map["timeformat"] = &chathandler::hash[e_time];
    map["nickformat"] = &chathandler::hash[e_nick];
    map["chatformat"] = &chathandler::hash[e_chat];
    map["actionformat"] = &chathandler::hash[e_action];
    map["buddyformat"] = &chathandler::hash[e_buddy];
    map["noticeformat"] = &chathandler::hash[e_notice];
    map["noticeactionformat"] = &chathandler::hash[e_noticeaction];
    map["prvformat"] = &chathandler::hash[e_prv];
    map["httpformat"] = &chathandler::hash[e_http];
    map["waformat"] = &chathandler::hash[e_wa];
    map["debugformat"] = &chathandler::hash[e_debug];
    map["garbagejoinformat"] = &chathandler::hash[e_garbagejoin];
    map["garbagepartformat"] = &chathandler::hash[e_garbagepart];
    map["garbagequitformat"] = &chathandler::hash[e_garbagequit];
    map["garbageformat"] = &chathandler::hash[e_garbage];
    map["myselfformat"] = &chathandler::hash[e_myself];
    map["ctcpformat"] = &chathandler::hash[e_ctcp];
    map["rawformat"] = &chathandler::hash[e_raw];
