...
flaglisthandler::flaglisthandler(){
...
flaglisthandler::~flaglisthandler(){}
//----------------------------------------------------------------------------------------------
QPixmap *flaglisthandler::getflag(QString country){
    if(!flaglist.contains(country.toLower().trimmed()))
        return flaglist["q"];
    return flaglist[country.toLower().trimmed()];
}
//----------------------------------------------------------------------------------------------
void flaglisthandler::fill(QComboBox *cb){
...
QVariant flaglisthandler::getflag(const userstruct &u) const{
    ...
    if(!flaglist.contains(u.country.toLower().trimmed())){
        myDebug()<<u.country.toLower().trimmed();
        return *flaglist["q"];
    }
