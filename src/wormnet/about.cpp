    ...
    : QFrame(parent)
{
    ...
    QString s=QString("<p>"+tr("Version")+" %1<br>" +
            ...
            "MihaiS<br>StepS<br>dbanet<br>DENnis<br>Kawoosh<br>CyberShadow<br>MonkeyIsland<br>kilobyte<br>Killer<br>eViL<br>kosmos<br>LeTotalKiller<br>Domi<br>CzAjNiK<br>WowwoW<br> and many others :)<br><br>" +
