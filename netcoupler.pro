...
RC_FILE = myapp.rc
TRANSLATIONS += Romanian_translation_The_Wheat_Snooper_by_MihaiS.ts \
    The_Wheat_Snooper_danish.ts \
    The_Wheat_Snooper_german_by_lookias.ts \
    The_Wheat_Snooper_international_spanish.ts \
    The_Wheat_Snooper_portugues.ts \
    The_Wheat_Snooper_spanish-(of_spain)_by_kosmos.ts \
    The_Wheat_Snooper_untranslated.ts \
